...
<div class="flex justify-center items-center w-full h-screen">
    <div class="flex items-center justify-center flex-col border-2 rounded-lg w-3/5 bg-white shadow-lg">
        ...
        <form class="space-y-4 w-4/5" method="post" action="{{'addGrade'}}">
            @csrf
            <div class="mb-6">
                <label for="large-input" class="block mb-2 text-sm font-medium text-gray-700">Podaj oceny wagi 1:</label>
                <input type="text" name="grades" placeholder="Np. 5, 4, 3" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-4 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Oblicz średnią</button>
            </div>
        </form>
