    ...
    <div class="w-full flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div class="w-full max-w-xl bg-white rounded-lg shadow-lg md:mt-0 xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="{{route('password.reset')}}" method="post">
                    @csrf
                    <div>
                    ...
                    <div>
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-700">Nowe hasło:</label>
                    ...
                    <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Resetuj hasło</button>
